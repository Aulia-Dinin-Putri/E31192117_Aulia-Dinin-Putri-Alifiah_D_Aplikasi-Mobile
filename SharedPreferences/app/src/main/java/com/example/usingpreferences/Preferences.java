...
public class Preferences {
     ...
     * Jadi setiap data mempunyai key yang berbeda satu sama lain untuk menambah / edit data*/
     ...
     * Penambahan mutator yang berguna untuk deklarasi SharedPreferences pada activity yang berbeda */
    private static SharedPreferences getSharedPreference(Context context){
        return PreferenceManager.getDefaultSharedPreferences(context);
    }
    /** Deklarasi Edit Preferences dan mengubah data yang memiliki key isi KEY_USER_TEREGISTER dengan parameter username */
    ...
    /** Deklarasi Edit Preferences dan mengubah data yang memiliki key KEY_PASS_TEREGISTER dengan parameter password */
    ...
    /** Deklarasi Edit Preferences dan mengubah data yang memiliki key KEY_USERNAME_SEDANG_LOGIN dengan parameter username */
    ...
    /** Deklarasi Edit Preferences dan mengubah data yang memiliki key KEY_STATUS_SEDANG_LOGIN dengan parameter status */
